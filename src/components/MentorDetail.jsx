...
const mentors = [
  {
    ...
    papersList: [
      ...
      { title: '作为艺术社会史镜像的20世纪中国艺术批评史——论陈旭光艺术批评史写作的整体观', file: '作为艺术社会史镜像的20世纪中国艺术批评史——论陈旭光艺术批评史写作的整体观_吴永强.pdf' },
      { title: '西南油画与当代油画的源流与现状', file: '西南油画与当代油画的源流与现状_吴永强.pdf' },
      ...
      { title: '审美现代性：当代艺术与现代传媒互动关系的表达', file: '审美现代性：当代艺术与现代传媒互动关系的表达_吴永强.pdf' },
      { title: '用情笔墨中，放怀笔墨外', file: '用情笔墨中,放怀笔墨外_吴永强.pdf' },
    ],
    coreConcept: {
